...
For each (a,b), let the integer solutions to u be defined by the sequence u_n with u_0=a. From the theory of Pell's equations we know u_n is the coefficient of 1 in (a+bsqrt(5))(9+4sqrt(5))^n
